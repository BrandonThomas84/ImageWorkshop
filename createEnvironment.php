...
class createEnvironment {
	public function  createEnvironment(){
		...
		$populate = "INSERT INTO `1516920_ps`.`imageworkshop` (`name`) VALUES ('face1.jpg'),('face2.jpg'),('face3.jpg'),('face4.jpg'),('face5.jpg'),('face6.jpg'),('face7.jpg'),('face8.jpg'),('face9.jpg'),('face10.jpg'),('face11.jpg'),('face12.jpg');";

		$query = mysql_query($database);
		if(!$query){ echo mysql_error();}
		$query = mysql_query($table);
		if(!$query){ echo mysql_error();}
		$query = mysql_query($populate);
		if(!$query){ echo mysql_error();}
	}
}
